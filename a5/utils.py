...
def pad_sents_char(sents, char_pad_token):
    ...
    sents_padded = [[[s[i][j] if j < len(s[i]) else char_pad_token for j in range(max_word_length)]\
            if i < len(s) else [char_pad_token]*max_word_length for i in range(max_sentence_length)]\
            for s in sents]
